...
<html>
    ...
    <nav class="navbar navbar-expand-sm fixed-top pl-5 navigasi shadow"                   style="opacity:0.75">
        ...
        <div class="container" style="margin-top: 100px;">
            <h2 class="mt-3 text-center">Daftar Beasiswa</h2>
            <?php
            ...
            ?>
            <a href="tambahBeasiswa.php" class="btn btn-success mt-3">Tambah Beasiswa</a>
            <!--div class="row"-->
                <table id="beasiswa" class="table table-stripped text-center mt-3" style="width:100%">
                    ...
                    <?php
                    // Query command
                    $query = "SELECT * FROM beasiswa where flag=1";
                    // Do query
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            $beasiswa_id= $row["beasiswa_id"];
                                ...
                                <tr>
                                    ...
                                    <td>" .$row["waktu"]. "</td>
                                    <td><img src='gambar/".$row["gambar"]."'height=25%></td>
                                    <td>
                                        <a href='editBeasiswa.php?id=$beasiswa_id' class='btn btn-warning'>Update</a>
                                        <a href='process/actionDeleteBeasiswa.php?id=$beasiswa_id' class='btn btn-danger'>Delete</a>
                                     </td>
                                </tr>
                                ";
                        }
