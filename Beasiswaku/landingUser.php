...
<html>
    <head>
        ...
        <h5>Tunggu apalagi segera cek daftar beasiswa dan segera daftarkan dirimu!</h5>
        <a class="js-scroll-trigger btn btn-lg btn-outline-dark " href="listbeasiswa.php">Check Daftar Beasiswa</a>
        <a class="js-scroll-trigger btn btn-lg btn-outline-dark " href="tampilRegister.php">Check Register</a>
        </section>
        </body>
</html>